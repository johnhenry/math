...
> referenced below are under that name. It now ships as `mallory-iteration`, part of the
> [Mallory](https://github.com/johnhenry/mallory) family, starting at 2.0.0 to keep continuity
